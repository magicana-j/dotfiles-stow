...
sudo xbps-install -Sy curl wget vim neovim unzip zip nano gparted xtools ntfs-3g fuse-exfat bash-completion linux-headers gcc htop fastfetch ufw gufw gvfs stow
...
sudo xbps-install -y pipewire wireplumber pavucontrol pulseaudio-utils
